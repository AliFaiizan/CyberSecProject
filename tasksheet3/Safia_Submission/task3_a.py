...
# ---------------------------------------------------------
def run_task3a(scenario, latent_file=None, M=20):
    """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Task 3(a): Feature Importance Analysis"
    )
    parser.add_argument(
        "--scenario", 
        type=int, 
    ...
    run_task3a(args.scenario, args.latent_file, args.window_size)