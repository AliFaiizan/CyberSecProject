...
- `synthetic_normal.npy`
- `synthetic_attack.npy` (used for controlled test construction)
...
All plots are saved in the `exports/` directory and submitted as part of the results.
...
- Stored in `exports/Scenario*/Venn` and `exports/Scenario*/UpSet`
